...
import org.fly.utils.log.CryptoConvertConfig.DefaultSensitiveObjectFastJsonConvertor;
import org.fly.utils.log.sensitive.SensitiveBankCard;
import org.fly.utils.log.sensitive.SensitiveCredential;
...
import org.fly.utils.log.sensitive.SensitiveName;
import org.fly.utils.validate.Pair;
...
public abstract class SensitiveObjectLogUtils {
	...
	public final static Object convert(Object value) {
		...
		// 已经有转换器的，直接转换
		DefaultSensitiveObjectFastJsonConvertor convertor = SensitiveObjectLogConvertorHolder.INSTANCE
				.getConvertor(value);
		if (convertor == null) {
			// 排除类不处理
