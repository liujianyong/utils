...
import org.fly.utils.log.sensitive.SensitiveBankCard;
import org.fly.utils.log.sensitive.SensitiveEmail;
import org.fly.utils.log.sensitive.SensitiveField;
import org.fly.utils.log.sensitive.SensitiveIDCard;
import org.fly.utils.log.sensitive.SensitiveIgnoreOut;
import org.fly.utils.log.sensitive.SensitiveMobile;
...
public class LogTest {
	...
	public static void test() {
		...
		assertTrue(Log.op("log idcard").kv("IDCard", "42010319840110461X", ConvertorTypeEnum.IDCARD).toString().endsWith("{IDCard=420103********461X}|" ));
		assertTrue(Log.op("log email").kv("email", "liujianyong@qq.com", ConvertorTypeEnum.EMAIL).toString().endsWith("{email=j****@qq.com}|"));
		assertTrue(Log.op("log idcard").kv("IDCard", "11010120141001261X", ConvertorTypeEnum.IDCARD).toString().endsWith("{IDCard=110101********261X}|" ));
		assertTrue(Log.op("log mobile").kv("mobile", "13798213421", ConvertorTypeEnum.MOBILE).toString().endsWith("{mobile=137****3421}|"));
		assertTrue(Log.op("log phone").kv("phone", "(0755)86071510", ConvertorTypeEnum.TELEPHONE).toString().endsWith("{phone=(0755)860***10}|" ));
		assertTrue(Log.op("log identity").kv("user", "liujianyong@qq.com", ConvertorTypeEnum.IDENTITY).toString().endsWith("{user=j****@qq.com}|"));
		assertTrue(Log.op("log identity").kv("user", "13798213421", ConvertorTypeEnum.IDENTITY).toString().endsWith("{user=137****3421}|"));
		assertTrue(Log.op("log identity").kv("user", "my_name_is_hh", ConvertorTypeEnum.IDENTITY).toString().endsWith("{user=m***********h}|"));
		assertTrue(Log.op("log identity").kv("user", "11010120141001261X", ConvertorTypeEnum.IDENTITY).toString().endsWith("{user=110101********261X}|"));
		assertTrue(Log.op("log bankcard").kv("bancard", "6226 0542 1354 8754", ConvertorTypeEnum.BANKCARD).toString().endsWith("{bancard=6226 05** **** 8754}|"));
		assertTrue(Log.op("log bankcard").kv("bancard", "6226054213548754", ConvertorTypeEnum.BANKCARD).toString().endsWith("{bancard=622605******8754}|"));
		assertTrue(Log.op("log bankcard").kv("bancard", "4270202235500236", ConvertorTypeEnum.BANKCARD).toString().endsWith("{bancard=427020******0236}|"));
		...
		System.out.println(Log.op("log bankcard").kv("bancard", "6226 0542 1354 8754 2254 1136", ConvertorTypeEnum.BANKCARD).toString());
		assertTrue(Log.op("log bankcard").kv("bancard", "6226 0542 1354 8754 2254 1136", ConvertorTypeEnum.BANKCARD).toString().endsWith("{bancard=6226 05** **** **** **** 1136}|"));
		assertTrue(Log.op("log bankcard").kv("bancard", "622605421354875422541136", ConvertorTypeEnum.BANKCARD).toString().endsWith("{bancard=622605**************1136}|"));
		...
		persons[0] = new Test("sz110023", "13755555249", "jddcdlld@foxmail.com", "6226000000009282", "11010120141001261X", "liujianyong4reg"); 
		persons[1] = new Test("sz110023", "13755555249", "jddcdlld@foxmail.com", "6226000000009282", "11010120141001261X", "liujianyong4reg"); 
		
		//System.out.println(persons instanceof Object[]);
		
		List<Test> personList = new ArrayList<Test>(); 
		personList.add(new Test("sz110023", "13755555249", "jddcdlld@foxmail.com", "6226000000009282", "11010120141001261X", "liujianyong4reg"));
		personList.add(new Test("sz110023", "13755555249", "jddcdlld@foxmail.com", "6226000000009282", "11010120141001261X", "liujianyong4reg"));
		...
		//System.out.println(SensitiveObjectLogUtils.convert(Arrays.asList("sz110023", "13755555249", "jddcdlld@foxmail.com", "6226000000009282", "11010120141001261X", "liujianyong4reg")));
		...
		assertTrue(Log.op("log object").kv("person", persons[0], ConvertorTypeEnum.OBJECT).toString()
				.endsWith("{person={\"age\":0,\"bankCard\":\"622600******9282\",\"customStr\":\"1101************1X\",\"email\":\"j*******@foxmail.com\","
						+ "\"idCard\":\"110101********261X\",\"identity\":\"j*******g\",\"mobile\":\"137****5249\",\"number\":\"sz110023\",\"test5\":{}}}|"));
		assertTrue(Log.op("log list object").kv("persons", personList, ConvertorTypeEnum.OBJECT).toString()
				.endsWith("{persons=[{\"age\":0,\"bankCard\":\"622600******9282\",\"customStr\":\"null\",\"email\":\"j*******@foxmail.com\","
						+ "\"idCard\":\"110101********261X\",\"identity\":\"j*******g\",\"mobile\":\"137****5249\",\"number\":\"sz110023\",\"test5\":{}},"
						+ "{\"age\":0,\"bankCard\":\"622600******9282\",\"customStr\":\"null\",\"email\":\"j*******@foxmail.com\",\"idCard\":\"110101********261X\","
						+ "\"identity\":\"j*******g\",\"mobile\":\"137****5249\",\"number\":\"sz110023\",\"test5\":{}}]}|"));
		assertTrue(Log.op("log array object").kv("persons", persons, ConvertorTypeEnum.OBJECT).toString()
				.endsWith("{persons=[{\"age\":0,\"bankCard\":\"622600******9282\",\"customStr\":\"1101************1X\",\"email\":\"j*******@foxmail.com\","
						+ "\"idCard\":\"110101********261X\",\"identity\":\"j*******g\",\"mobile\":\"137****5249\",\"number\":\"sz110023\",\"test5\":{}},"
						+ "{\"age\":0,\"bankCard\":\"622600******9282\",\"customStr\":\"null\",\"email\":\"j*******@foxmail.com\",\"idCard\":\"110101********261X\","
						+ "\"identity\":\"j*******g\",\"mobile\":\"137****5249\",\"number\":\"sz110023\",\"test5\":{}}]}|"));
		assertTrue(Log.op("log map object").kv("persons", maps, ConvertorTypeEnum.OBJECT).toString()
				.endsWith("{persons={\"611437735\":{\"age\":0,\"bankCard\":\"622600******9282\",\"customStr\":\"null\",\"email\":\"j*******@foxmail.com\","
						+ "\"idCard\":\"110101********261X\",\"identity\":\"j*******g\",\"mobile\":\"137****5249\",\"number\":\"sz110023\",\"test5\":{}},"
						+ "\"97730845\":{\"age\":0,\"bankCard\":\"622600******9282\",\"customStr\":\"1101************1X\",\"email\":\"j*******@foxmail.com\","
						+ "\"idCard\":\"110101********261X\",\"identity\":\"j*******g\",\"mobile\":\"137****5249\",\"number\":\"sz110023\",\"test5\":{}}}}|"));
		...
		nestedTest.setValue("liujianyong");
		nestedTest.setMyEmail("liujianyongabc1123@qq.com");
		...
		assertTrue(Log.op("log object").kv("nested object", nestedTest, ConvertorTypeEnum.OBJECT).toString()
				.endsWith("{\"myEmail\":\"j***********@qq.com\","
						+ "\"test\":{\"age\":10,\"bankCard\":\"622600******9282\",\"customStr\":\"1101************1X\","
						+ "\"email\":\"j*******@foxmail.com\",\"idCard\":\"110101********261X\",\"identity\":\"j*******g\","
						+ "\"mobile\":\"137****5249\",\"number\":\"sz110023\",\"test5\":{}},"
						+ "\"test2\":{\"idCard\":\"110101********261X\"},\"test3\":{\"t\":{\"bankCard\":\"622600******9282\","
						+ "\"idCard\":\"110101********261X\",\"mobile\":\"137****5249\"},\"test5\":{\"mobile\":\"137****5249\"}},"
						+ "\"testList\":[{\"age\":0,\"bankCard\":\"622600******9282\",\"customStr\":\"null\","
						+ "\"email\":\"j*******@foxmail.com\",\"idCard\":\"110101********261X\",\"identity\":\"j*******g\","
						+ "\"mobile\":\"137****5249\",\"number\":\"sz110023\",\"test5\":{\"mobile\":\"null\"}},"
						+ "{\"age\":0,\"bankCard\":\"622600******9282\",\"customStr\":\"null\",\"email\":\"j*******@foxmail.com\","
						+ "\"idCard\":\"110101********261X\",\"identity\":\"j*******g\",\"mobile\":\"137****5249\","
						+ "\"number\":\"sz110023\",\"test5\":{\"mobile\":\"null\"}}],\"testMap\":{\"611437735\":{\"age\":0,"
						+ "\"bankCard\":\"622600******9282\",\"customStr\":\"null\",\"email\":\"j*******@foxmail.com\","
						+ "\"idCard\":\"110101********261X\",\"identity\":\"j*******g\",\"mobile\":\"137****5249\","
						+ "\"number\":\"sz110023\",\"test5\":{\"mobile\":\"null\"}},\"97730845\":{\"$ref\":\"$.test\"}},"
						+ "\"tests\":[{\"$ref\":\"$.test\"},{\"$ref\":\"$.testMap.611437735\"}],\"value\":\"liujianyong\"}}|"));
